...
def test_exact(info_dict, exact_likelihood, ref_like_values):
    ...
    print(loglike)
    np.testing.assert_almost_equal(loglike, ref_like_values["exact"], decimal=10)
...
def test_gaussian(info_dict, gauss_likelihood, ref_like_values):
    ...
    loglike = model.loglikes()[0][0]
    print(loglike)
    np.testing.assert_almost_equal(loglike, ref_like_values["gauss"], decimal=10)
...
def test_correlated(info_dict, correlated_likelihood, ref_like_values):
    ...
    loglike = model.loglikes()[0][0]
    print(loglike)
    np.testing.assert_almost_equal(loglike, ref_like_values["correlated"], decimal=10)
...
def test_hl(info_dict, hl_likelihood, ref_like_values):
    ...
    loglike = model.loglikes()[0][0]
    print(loglike)
    np.testing.assert_almost_equal(loglike, ref_like_values["hl"], decimal=10)
...
def test_lollipop(info_dict, lollipop_likelihood, ref_like_values):
    ...
    loglike = model.loglikes()[0][0]
    print(loglike)
    np.testing.assert_almost_equal(loglike, ref_like_values["lollipop"], decimal=10)
